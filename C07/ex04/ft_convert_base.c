...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/02/06 09:44:07 by anshovah          #+#    #+#             */
/*   Updated: 2023/02/14 13:54:41 by anshovah         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		ft_lenght_nbr(int nbr, char *base, int lenght);
...
int	ft_whitespaces(char *str, int *ptr_i)
{
	int	count;
	int	i;
...
int	ft_atoi_base(char *str, char *base)
{
	...
	if (base_lenght >= 2)
	{
		count = ft_whitespaces(str, &i);
		nb2 = ft_nb_base(str[i], base);
		while (nb2 != -1)
		{
...
char	*ft_convert_base(char *nbr, char *base_from, char *base_to)
{
	...
	lenght_nbrf = ft_lenght_nbr(mednbr, base_to, 0);
